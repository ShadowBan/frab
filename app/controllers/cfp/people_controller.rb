class Cfp::PeopleController < ApplicationController
  ...
  def import
    ...
    respond_to do |format|
      ...
      foaf_params = foaf.permit(:first_name, :public_name, :email, :email_public, :include_in_mailings, :gender, :abstract, :description)
      if @person.update_attributes(foaf_params)
